...
char *str_01234567="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
...
bool ny_htmlproc_4a(char * arg_0)
{
	...
	if (local_00!=0&&local_00!=10&&local_00!=11) {
		return false;
	}
	for (local_01=0; local_01<local_00; local_01++) {
		if (strchr(str_01234567,(int)*(arg_0+local_01))==0) {
			return false;
		}
	}
	return true;
...
//	local_00="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
	local_01=strlen(str_01234567);
	for (local_02=0; local_02<10; local_02++) {
		*dest=*((char *)(str_01234567+(int)(unsigned char)local_03[local_02]%local_01));
		dest=dest+1;
	}
	*dest=0;
	return;
