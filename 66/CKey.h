...
public:
	...
	bool operator < (const CKeySorter & arg_0) const
	{
		...
		if (m_flag_unk4) {
			...
			case 3:
				local_00=(double)m_pCKey->mf_CKey_0150()/(double)m_pCKey->mf_CKey_0170();
				local_01=(double)arg_0.m_pCKey->mf_CKey_0150()/(double)arg_0.m_pCKey->mf_CKey_0170();
		...
		case 2:
			return (bool)(m_pCKey->m_uint_unk13>arg_0.m_pCKey->m_uint_unk13);
		case 3:
			local_02=(double)m_pCKey->mf_CKey_0150()/(double)m_pCKey->mf_CKey_0170();
			local_03=(double)arg_0.m_pCKey->mf_CKey_0150()/(double)arg_0.m_pCKey->mf_CKey_0170();
