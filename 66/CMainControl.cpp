...
void CMainControl::mf_CMainControl_0190()
{
	...
	m_optflag_notConnected__=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","NotConvert",0);
	m_optflag_notConvert__=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","Connect",1);
	m_optflag_Connect__=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","DisplayUpFile",1);
	m_optflg_displayUpFile_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","DisplayCacheFile",1);
	m_optflg_displayCacheFile_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","DisplayTmpCacheFile",1);
	m_optflg_displayTmpCacheFile_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","DisplayNonWritableBbs",1);
	m_optflg_displayNonWritableBbs_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","UseTransferLimit",0);
	m_optflg_useTransferLimit_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","UseMultiDownload",1);
	m_optflg_useMultiDownload_=(local_08?true:false);//!(local_08==0);
	m_flg_unk15509=false;
	local_08=local_05->ReadInteger("Option","CutSlowLine",0);
	m_optflg_cutSlowTransfer_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","DownRetryFast",1);
	m_optflg_downRetryFast_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","SearchIgnore",0);
	m_optflg_searchIgnore_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","AutoTabChange",1);
	m_optflg_autoTabChange_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","DisplayNewCache",0);
	m_optflg_displayNewCache_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","UseTipPopup",1);
	m_optflg_useTipPopup_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","UseBlackColor",0);
	m_optflg_UseBlackColor_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","UseBlackColor",0);
	m_optflg_UseBlackColor_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","UseBbsOnly",0);
	m_optflg_UseBbsOnly_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","MakeMarkFile",1);
	m_optflg_makeMarkFile_=(local_08?true:false);//!(local_08==0);
	g_float_unk101=!(!m_optflg_UseBlackColor_)?(float)1.0:(float)3.0;
	local_08=local_05->ReadInteger("Option","UseBbsBlackColor",0);
	m_optflg_UseBbsBlackColor_=(local_08?true:false);//!(local_08==0);
	local_08=local_05->ReadInteger("Option","V4CacheNotDown",0);
	m_optflg_V4CacheNotDown_=(local_08?true:false);//!(local_08==0);
				...
				while (true) {
					...
					if (local_03==0||m_KeyBuffer_.count(local_05)!=0) {
						...
						for (; local_06!=m_KeyBuffer_.end(); local_06++) {
							...
							if ((
								(local_07->m_bln_unk308||!m_optflg_displayUpFile_&&local_07->m_char_keyType_==KEYTYPE02||!m_optflg_displayCacheFile_&&local_07->m_char_keyType_==KEYTYPE03)
								...
								||!(m_optflg_displayTmpCacheFile_
								||local_07->m_char_keyType_!=KEYTYPE01)&&!mf_CMainControl_1180(local_07)
								) continue;
							local_07->m_bln_unk303=false;
							local_07->m_bln_unk304=false;
							...
							local_00[local_02].m_double_unk2=(double)(local_07->m_uint_unk204^0x98765432);
...
void CMainControl::mf_CMainControl_0770()
{
	...
	if (!m_optflg_showVersionWarning_) {
		local_00=0;
		for (local_01=1; local_01<600; local_01++) {
			if (!m_hostArray[local_01].m_flgIsValid||m_hostArray[local_01].m_int_version<=12660) continue;
			local_00=local_00+1;
		}
		if (local_00>3) {
...
void CMainControl::mf_CMainControl_0780(int arg_0)
{
	...
	for (local_01=0; local_01<5; local_01++) {
		...
		if (local_04==0) {
			...
			if (! ( ( (memcmp(local_05+4,"Winny Ver2.0b1",14)!=0)|| *((int *)local_05)<12647 || *((int *)local_05)>=12800 ) ) ) {
				local_02->SetVersion( *((int *)local_05) );
				if (*((int *)local_05)>12660) {
...
char local_09;
			...
			if (local_04==0||!(local_04<'a')&&local_04<='c') continue;
			local_02->mf_CHost_0190(true);
		}//orphan jump用
	}
	return;
...
void CMainControl::mf_CMainControl_0890(int arg_0)
{
	...
	if (! (!(memcmp(m_hash_exeHash_,g_exesignature_defined,16)!=0)&&memcmp(m_hash_memorySignature_,g_memorysignature_compared,16)==0||m_hostArray[local_05].m_int_connectionTimeInSec<412) ) {
	char local_10;
		local_10=31;
...
//									if (! (local_18->m_char_keyType_!=KEYTYPE00||(local_18->m_uint_unk204^0x98765432)*local_18->m_uint_unk206<=0x00027100) ) {
	...
	if (! (arg_4==0||!local_02->m_flg_unk01&&!local_02->m_flg_unk02) ) {
		...
		for (local_33=0; local_33<local_22; local_33++) {
			if ((!local_02->mf_CQuery_0040(local_33,(_in_addr *)local_35,&local_23,(_in_addr *)local_36,&local_24,local_37,&local_28,(unsigned int *)/*nya*/&local_25,local_38,&local_27,&local_30,&local_29,&local_31,local_40,&local_32,local_41)||memcmp(local_38,local_39,16)==0||local_27>=0x000186A0)||!(!local_02->m_flg_isBbsQuery__)&&local_25>0x00100000
			  ...
			  ||!(!local_02->m_flg_isBbsQuery__)&&local_40[0]==0||(local_35[0]==127||local_35[0]==192)
...
//4544f8 このへん変数アサインが変
			...
			if (local_04->m_int_connectionTimeInSec>1) {
				...
				if (! (memcmp(m_hash_memorySignature_,g_memorysignature_compared,16)==0||local_04->m_int_connectionTimeInSec<g_int_unk415*7) ) {
					char local_07;
					local_07=31;
					...
					if (! ( (local_13->m_double_unk10>=3999.0 || m_KeySearchTable_.count(local_18)==0) ) ) {
						...
						for (local_19=m_KeySearchTable_.find(local_18); local_19!=m_KeySearchTable_.end(); local_19++) {
							...
							for (local_21=m_KeyBuffer_.find(local_20); local_21!=m_KeyBuffer_.end(); local_21++) {
								...
								if ((local_22->m_char_keyType_==KEYTYPE02||local_22->m_bln_unk302)||!(!local_13->m_flag_unk5)&&!local_22->m_bln_unk308||!local_13->m_flag_unk5&&local_22->m_bln_unk308||!(local_22->m_bln_unk308||local_22->m_portno_0__!=local_22->m_portno_2__)&&memcmp(&local_22->m_ipaddr_0__,&local_22->m_ipaddr_2__,4)==0||!(!m_optflg_V4CacheNotDown_)&&local_22->m_int_unk203==4) continue;
