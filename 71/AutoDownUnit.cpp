...
//				g_pCMainControl->mf_CMainControl_0070(KeywordCombo->Text.c_str(),NULLPO,local_10,(unsigned char *)TripCombo->Text.c_str(),atof(UpperSizeEdit->Text.c_str()),atof(LowerSizeEdit->Text.c_str()),BbsCheck->Checked,AutoDeleteCheck->Checked,DeleteCheck->Checked,DisconnectCheck->Checked);
				g_pCMainControl->mf_CMainControl_0070(KeywordCombo->Text.Trim().c_str(),NULLPO,local_10,(unsigned char *)TripCombo->Text.Trim().c_str(),atof(UpperSizeEdit->Text.Trim().c_str()),atof(LowerSizeEdit->Text.Trim().c_str()),BbsCheck->Checked,AutoDeleteCheck->Checked,DeleteCheck->Checked,DisconnectCheck->Checked);
			} else {
				local_07->m_flg_unk0=true;
				local_07->Set_keyword(KeywordCombo->Text.Trim().c_str());
				local_07->Set_Tripstr(TripCombo->Text.Trim().c_str());
				char * local_14;
				local_14=local_10;
				if (local_14!=0) {
				...
				local_07->m_flg_unk0=true;
				local_07->Set_UpperSizeLimit(atof(UpperSizeEdit->Text.Trim().c_str()));
				local_07->Set_LowerSizeLimit(atof(LowerSizeEdit->Text.Trim().c_str()));
...
//				g_pCMainControl->mf_CMainControl_0060(KeywordCombo->Text.c_str(),0,(unsigned char *)local_10,(char *)TripCombo->Text.c_str(),atof(UpperSizeEdit->Text.c_str()),atof(LowerSizeEdit->Text.c_str()),BbsCheck->Checked,AutoDeleteCheck->Checked,DeleteCheck->Checked,DisconnectCheck->Checked,false);
				g_pCMainControl->mf_CMainControl_0060(KeywordCombo->Text.Trim().c_str(),0,(unsigned char *)local_10,(char *)TripCombo->Text.Trim().c_str(),atof(UpperSizeEdit->Text.Trim().c_str()),atof(LowerSizeEdit->Text.Trim().c_str()),BbsCheck->Checked,AutoDeleteCheck->Checked,DeleteCheck->Checked,DisconnectCheck->Checked,false);
			} else {
				local_06->m_flg_unk0=true;
				local_06->Set_keyword(KeywordCombo->Text.Trim().c_str());
				local_06->Set_Tripstr(TripCombo->Text.Trim().c_str());
				char * local_17;
				local_17=local_10;
				if (local_17!=0) {
				...
				local_06->m_flg_unk0=true;
				local_06->Set_UpperSizeLimit(atof(UpperSizeEdit->Text.Trim().c_str()));
				local_06->Set_LowerSizeLimit(atof(LowerSizeEdit->Text.Trim().c_str()));
